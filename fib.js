...
var generate = function () 
{
    ...
    var k; // k is calulated by addingn i + j and representing the next Fibonacci number
	...
	// number of fibonacci numbers and then post it to the html DOM
         while (intCount >2)
        {
            ...
            j=k; // sets the new j = to the current k. i and j must be set in this order in the loop
